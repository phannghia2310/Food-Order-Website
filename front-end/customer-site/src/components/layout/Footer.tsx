    ...
    <footer className="bg-gray-950 pt-12">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-6 px-10 lg:px-48">
        <div className="col-span-full lg:col-span-1 lg:block">
          <Link href="/" className='text-primary text-2xl font-josefin'>Fly Pizza</Link>
          <div className="mt-6 flex gap-6">
            <a href="https://x.com/"><TwitterIcon className={"w-6"} /></a>
            <a href='https://facebook.com'><FaceBookIcon className={"w-6"} /></a>
            <a href='https://instagram.com'><InstaIcon className={"w-6"}/></a>
          </div>
        </div>
          ...
          <div className="mt-6 text-gray-400">
            <ul className="space-y-2">
              <li className="inline-flex space-x-4">
                ...
                <span>1159 TL10, Tan Tao, Binh Tan, Ho Chi Minh City</span>
              </li>
              <li className="inline-flex space-x-4">
                <span><PhoneIcon className={"w-6"} /></span>
                <span>+84 562 612 494</span>
              </li>
              <li className="inline-flex space-x-4">
                <span><MailIcon className={"w-6"} /></span>
                <span>phankhacbaonghia@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
