        ...
        <div className="col-span-2 py-8 bg-dark">
          <div className='grid-cols-3 flex justify-center gap-16'>
            <div className='flex gap-4 items-center'>
              ...
              <p className='text-lg font-semibold'>(84) 562 612 494</p>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <div className='text-center'>
              <p className='text-lg font-semibold'>1159 TL10, Tan Tao,</p>
              <p className='text-gray-400'>Binh Tan, Ho Chi Minh City</p>
              </div>
            </div>
            <div className='flex gap-4 items-center'>
