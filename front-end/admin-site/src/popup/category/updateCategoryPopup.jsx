...
const UpdateCategoryPopup = ({ isOpen, onClose, category }) => {
    ...
    const handleUpdate = async (e) => {
        ...
        if(validateUpdate()) {
            try {
                ...
                console.error(err);
                const newErrors = {};
                newErrors.categoryName = err.response.data;
                setErrors(newErrors);
            }
        }
    };
                        ...
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                <div className="w-full">
                                    <Typography variant="small" color="blue-gray" className="mt-3 font-medium">Category Name</Typography>
                                    <Input type="text" name="categoryName" id="categoryName" size="lg" value={formData.categoryName || ''} onChange={handleChange} error={errors.categoryName}/>
                                    {errors.categoryName && 
                                    ...
                                    <div className="flex items-center mt-3">
                                        <input className="mr-2" type="checkbox" name="isActive" id="isActive" checked={formData.isActive || ''} onChange={handleChange} />
